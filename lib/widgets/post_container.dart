        ...
        children: [Padding(
          ...
          child: Column(
            ...
            children: [_PostHeader(post:post),
              ...
              Text(post.caption), post.imageUrl !=null? const SizedBox.shrink():const SizedBox(height: 6.0,)],
          ),
        ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Row(children: [Text('${post.timeAgo} . ', style: TextStyle(color: Colors.grey[600], fontSize: 12.0 ),), Icon(Icons.public, color:Colors.grey[600], size: 12.0)],),
            ],
          ),
        ),
...
class _PostStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      const Divider(),
      Row(children: [
        _PostButton(icon: Icon(MdiIcons.thumbUp, color: Colors.grey[600], size: 25.0,),label: 'Like', onTap: ()=> print('Like'),),
        _PostButton(icon: Icon(MdiIcons.comment, color: Colors.grey[600], size: 25.0,),label: 'Comment', onTap: ()=> print('Comment'),),
        _PostButton(icon: Icon(MdiIcons.share, color: Colors.grey[600], size: 25.0,),label: 'Share', onTap: ()=> print('Share'),),
      ],),
    ],);
  }
}
